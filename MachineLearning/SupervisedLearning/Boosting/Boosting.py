...
if True:
    ...
    for i in range(1,5):
        ...
        d = EL_Boosting(fileList, num, prune, depth, 2, False, True, 25, random_state)
...
if False:
    ...
    for numb in np.arange(testMinNum, testMaxNum, testNumStep):
        d = EL_Boosting(["../Sarcasm/Sarcasm_train_set_1.csv","../Sarcasm/Sarcasm_train_set_2.csv","../Sarcasm/Sarcasm_train_set_3.csv"], numb, prune, depth, 2, False, True, 100, random_state)
        print("Num: " + str(numb))
        start = time.perf_counter()
        percent = d.Predict("../Sarcasm/Sarcasm_train_set_4.csv", num*3, False, "../Sarcasm/Sarcasm_result_ELB_0.csv")
    ...
    np.savetxt("../Sarcasm/Sarcasm_result_ELB_vsSize.csv", result, delimiter=",")
...
if False:
    ...
    hlsList = [[d for d in np.arange(prune_min, prune_max, prune_step)], [0 for d in np.arange(prune_min, prune_max, prune_step)]]
    i = 0
    for prune in np.arange(prune_min, prune_max, prune_step):
        d = EL_Boosting(["../Sarcasm/Sarcasm_train_set_1.csv","../Sarcasm/Sarcasm_train_set_2.csv","../Sarcasm/Sarcasm_train_set_3.csv"], num, prune, depth, 2, False, True, 100, random_state)
        print("Prune: " + str(prune))
        ...
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sarcasm/Sarcasm_result_ELB_prune.csv", result, delimiter=",")
...
if False:
    ...
    hlsList = [[d for d in np.arange(depth_min, depth_max, depth_step)], [0 for d in np.arange(depth_min, depth_max, depth_step)]]
    i = 0
    for depth in np.arange(depth_min, depth_max, depth_step):
        d = EL_Boosting(["../Sarcasm/Sarcasm_train_set_1.csv","../Sarcasm/Sarcasm_train_set_2.csv","../Sarcasm/Sarcasm_train_set_3.csv"], num, prune, depth, 2, False, True, 100, random_state)
        ...
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sarcasm/Sarcasm_result_ELB_depth.csv", result, delimiter=",")
...
if False:
    ...
    hlsList = [[d for d in np.arange(est_min, est_max, est_step)], [0 for d in np.arange(est_min, est_max, est_step)]]
    i = 0
    for est in np.arange(est_min, est_max, est_step):
        d = EL_Boosting(["../Sarcasm/Sarcasm_train_set_1.csv","../Sarcasm/Sarcasm_train_set_2.csv","../Sarcasm/Sarcasm_train_set_3.csv"], num, prune, depth, 2, False, True, est, random_state)
        print("Estimators: " + str(est))
        percent = d.Predict("../Sarcasm/Sarcasm_train_set_4.csv", num*3, False, "../Sarcasm/Sarcasm_result_ELB_0.csv")
        hlsList[1][i] = percent
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sarcasm/Sarcasm_result_ELB_est.csv", result, delimiter=",")
...
if True:
    ...
    for i in range(1,5):
        ...
        d = EL_Boosting(fileList, num, prune, depth, 2, False, True, 35, random_state)
...
if False:
    ...
    i = 0
    for numb in np.arange(testMinNum, testMaxNum, testNumStep):
        d = EL_Boosting(["../Sentiment/Sentiment_train_set_1.csv","../Sentiment/Sentiment_train_set_2.csv","../Sentiment/Sentiment_train_set_3.csv"], numb, prune, depth, 2, False, True, 100, random_state)
        print("Num: " + str(numb))
        start = time.perf_counter()
        percent = d.Predict("../Sentiment/Sentiment_train_set_4.csv", num*3, False, "../Sentiment/Sentiment_result_ELB_0.csv")
        totalTime = time.perf_counter() - start
        print("Total Time: " + str(totalTime))
        numList[1][i] = percent
        numList[2][i] = totalTime
        i += 1
    result = np.asfarray(numList)
    np.savetxt("../Sentiment/Sentiment_result_ELB_vsSize.csv", result, delimiter=",")
...
if False:
    ...
    i = 0
    for prune in np.arange(prune_min, prune_max, prune_step):
        d = EL_Boosting(["../Sentiment/Sentiment_train_set_1.csv","../Sentiment/Sentiment_train_set_2.csv","../Sentiment/Sentiment_train_set_3.csv"], num, prune, depth, 2, False, True, 100, random_state)
        print("Prune: " + str(prune))
        percent = d.Predict("../Sentiment/Sentiment_train_set_4.csv", num*3, False, "../Sentiment/Sentiment_result_ELB_0.csv")
        hlsList[1][i] = percent
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sentiment/Sentiment_result_ELB_prune.csv", result, delimiter=",")
...
if False:
    ...
    for depth in np.arange(depth_min, depth_max, depth_step):
        ...
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sentiment/Sentiment_result_ELB_depth.csv", result, delimiter=",")
...
if False:
    ...
    i = 0
    for est in np.arange(est_min, est_max, est_step):
        d = EL_Boosting(["../Sentiment/Sentiment_train_set_1.csv","../Sentiment/Sentiment_train_set_2.csv","../Sentiment/Sentiment_train_set_3.csv"], num, prune, depth, 2, False, True, est, random_state)
        print("Estimators: " + str(est))
        percent = d.Predict("../Sentiment/Sentiment_train_set_4.csv", num*3, False, "../Sentiment/Sentiment_result_ELB_0.csv")
        hlsList[1][i] = percent
        i += 1
    result = np.asfarray(hlsList)
    np.savetxt("../Sentiment/Sentiment_result_ELB_est.csv", result, delimiter=",")
